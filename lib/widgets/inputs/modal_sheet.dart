...
buildModalSheet(
  ...
  if (isCreatePost) _linkController = TextEditingController();
  ...
  showModalBottomSheet(
      ...
      builder: (context) => Container(
            height: PlatformServices.isWebMobile
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: !PlatformServices.isWebMobile ? 100 : 20),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(title,
                            style:
                                AppStyles.poppinsBold22.copyWith(fontSize: 18)),
                      ],
                    ),
                  ),
                  Padding(
